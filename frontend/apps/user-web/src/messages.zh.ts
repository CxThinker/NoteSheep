export const zhCNMessages = {
  ...
  shell: {
    ...
    deletedNotebooks: "已删除笔记本",
    emptyDeletedNotebooks: "暂无已删除笔记本",
    openNotebook: "打开笔记本 {notebookName}",
    deleteNotebook: "删除笔记本 {notebookName}",
    deleteNotebookAction: "删除笔记本",
    restoreNotebook: "恢复笔记本 {notebookName}",
    permanentDeleteNotebook: "彻底删除笔记本 {notebookName}",
    permanentDeleteNotebookAction: "彻底删除笔记本",
    notebookNameRequired: "请输入笔记本名称。",
    notebookActionFailed: "笔记本操作失败，请稍后重试。",
    notebookDeleteFailed: "笔记本删除失败，请稍后重试。",
    notebookRestoreFailed: "笔记本恢复失败，请稍后重试。",
    notebookPermanentDeleteFailed: "笔记本彻底删除失败，请稍后重试。",
    notebookLoadFailed: "笔记本读取失败，请稍后重试。",
    deletedNotebookLoadFailed: "已删除笔记本读取失败，请稍后重试。",
    notebookTreeLoadFailed: "笔记本内容读取失败，请稍后重试。",
    confirmDeleteNotebook: "确定要删除笔记本 {notebookName} 吗？可在已删除笔记本中恢复。",
    confirmPermanentDeleteNotebook: "确定要彻底删除笔记本 {notebookName} 吗？此操作不可恢复。",
    ...
    confirmPermanentDeleteNodeTitle: "彻底删除节点",
